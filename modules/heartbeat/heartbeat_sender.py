...
class HeartbeatSender:
    ...
    @classmethod
    def create(
        cls, connection: mavutil.mavfile, heartbeat_sender_logger: logger.Logger
        ...
        if connection is None:
            heartbeat_sender_logger.error(
                "HeartbeatSender creation failed. No connection provided (Connection is None).",
                True,
            )
            return False, None
    ...
    def __init__(
        self, key: object, connection: mavutil.mavfile, heartbeat_sender_logger: logger.Logger
    ) -> None:
